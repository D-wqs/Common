...
//    }
    ...
    public static Cache initCache(String cacheName, long timeToLiveSeconds) throws Exception {
        return EHCacheUtil.initCache(cacheName, EHCacheGlobal.MAXELEMENTSINMEMORY, EHCacheGlobal.OVERFLOWTODISK,
                EHCacheGlobal.ETERNAL, timeToLiveSeconds, EHCacheGlobal.TIMETOIDLESECONDS);
    }
    ...
    public static Cache initMyCache(String cacheName) throws Exception {
        return EHCacheUtil.initCache(cacheName, EHCacheGlobal.TIMETOlIVESECONDS);
    }
    ...
    public static boolean setValue(String cacheName, String key, Object value, Integer timeToLiveSeconds) throws Exception {
        try {
            ...
            myCache.put(new Element(key, value, EHCacheGlobal.ETERNAL, EHCacheGlobal.TIMETOIDLESECONDS, timeToLiveSeconds));
            return true;
        } catch (Exception e) {
            throw new Exception("set cache " + cacheName + " failed!!!");
        }
...
//        }
//        String[] allCaches = EHCacheUtil.getAllCaches();
//        System.out.println(Arrays.toString(allCaches));
//        List keys1 = EHCacheUtil.getKeys();
//        for (int i = 0; i < keys1.size(); i++) {
//            Object o = keys1.get(i);
//            System.out.println("value:"+o.toString());
//        }
//        EHCacheUtil.initCacheManager();
//        Cache cache = EHCacheUtil.initCache("user");
//        List keys2 = cache.getKeys();
//        for (int i = 0; i < keys2.size(); i++) {
//            System.out.println("userCache:" + keys2.get(i).toString());
//        }
