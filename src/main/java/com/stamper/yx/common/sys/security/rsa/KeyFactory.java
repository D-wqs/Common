...
public class KeyFactory {
	...
	public static PrivateKey getPrivateKey() {
		...
		try {
			priPKCS8 = new PKCS8EncodedKeySpec(
					new BASE64Decoder().decodeBuffer(str_priK));
	...
	public static PublicKey getPubKey() {
		...
		try {
			// 自己的公钥(测试)
			java.security.spec.X509EncodedKeySpec bobPubKeySpec = new java.security.spec.X509EncodedKeySpec(Base64.getDecoder().decode(str_pubK));
			// RSA对称加密算法
